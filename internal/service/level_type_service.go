...
type LevelTypeService interface {
	...
	Create(ctx context.Context, name, icon string) (*domain.LevelType, error)
...
func (s *levelTypeService) Create(ctx context.Context, name, icon string) (*domain.LevelType, error) {
	lt := &domain.LevelType{Name: name, Icon: icon}
