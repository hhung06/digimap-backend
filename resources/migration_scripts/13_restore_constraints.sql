...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'venues_customer_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'venue_user_roles_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'venue_invitations_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'map_groups_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'levels_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'levels_map_group_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'levels_perspective_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'geo_references_level_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'location_categories_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'locations_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'locations_level_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'locations_main_category_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'location_category_links_location_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'location_category_links_category_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'location_images_location_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'product_categories_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'products_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'products_location_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'products_main_category_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'product_category_links_product_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'product_category_links_category_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'product_attachments_product_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'event_types_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'events_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'events_type_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'event_tag_links_event_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'event_tag_links_tag_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'event_location_links_event_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'event_location_links_location_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'event_images_event_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'surveys_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'surveys_created_by_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'questions_survey_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'options_question_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'survey_responses_survey_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'survey_answers_response_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'survey_answers_question_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'survey_answers_option_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'advertisements_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'advertisements_location_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'articles_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'articles_location_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'article_images_article_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'coupons_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'beacons_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'beacons_level_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'connections_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'connection_levels_connection_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'connection_levels_level_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'snapshots_venue_id_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                 WHERE constraint_name = 'snapshots_created_by_fk') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'customers') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'users') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'venues') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'venue_user_roles') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'venue_invitations') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'map_groups') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'perspectives') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'levels') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'geo_references') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'location_categories') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'locations') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'location_images') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'product_categories') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'products') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'product_attachments') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'event_types') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'event_tags') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'events') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'event_images') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'surveys') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'questions') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'options') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'survey_responses') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'survey_answers') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'beacons') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'connections') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'connection_levels') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'advertisements') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'articles') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'article_images') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'coupons') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'tags') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'search_queries') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.triggers
                 WHERE trigger_name = 'set_updated_at' AND event_object_table = 'snapshots') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'customers' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'venues' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'venue_user_roles' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'venue_invitations' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'map_groups' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'perspectives' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'levels' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'geo_references' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'location_categories' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'location_images' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'product_categories' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'products' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'product_attachments' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'event_types' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'event_tags' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'events' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'event_images' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'surveys' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'questions' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'options' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'survey_responses' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'survey_answers' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'beacons' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'connections' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'connection_levels' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'advertisements' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'articles' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'article_images' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'coupons' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'tags' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'search_queries' AND column_name = 'id' AND data_type = 'uuid') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns
             WHERE table_name = 'snapshots' AND column_name = 'id' AND data_type = 'uuid') THEN
